...
1. I’d never thought of sleep as something that could be engineered. The schools I attended didn’t offer sleep classes. No one pulled me aside and gave me tips. So, like most, I just crossed my fingers each day and hoped for the best until I read Matthew Walker’s book Why We Sleep, which introduced me to the science of sleep.
   ...
   **my comment**: I come from a more road cycling background where you can measure all kinds of things (e.g. training load or TSS, power data, CdA...) and there's so much [[information]] (millions of research papers) there on how to optimize aerodynamics and your training to achieve an outcome, and I sometimes like to imagine this will be the case in the future with things like optimizing sleep for certain outcomes as well. Including (what we call in [[sports science]]) the 'marginal gains', which all combined can really stack up and produce big outcomes (e.g. saving 0.5 watts here and there for aerodynamics as a cyclist).^[[Sleep and Impulse Control. It’s 7 pm. A freshly baked sugar cookie… | by Bryan Johnson | Future Literacy | Medium](https://medium.com/future-literacy/sleep-and-impulse-control-87e844218ff2)]
...
8. body [[temperature]] meter → falling asleep earlier than when hitting minimum core body [[temperature]]
	...
	2. The technology behind Eight Sleep’s Pod is designed to learn and respond to your body’s [[temperature]] needs.  The Pod’s advanced Sensing Technology layer detects your heartbeat, breathing patterns, [[temperature]], and more to gather a full picture of your sleep profile.  The Pod continually monitors and analyzes your sleep data with our Intelligent SmartTemp™ AI.  Trained on over 70 million hours of sleep data, our SmartTemp™ algorithms learn over [[time]] what your body requires for better sleep, delivering the most ideal sleep [[temperature]] through the Pod’s Active Grid.  Our technology also allows for dual-zone control, so the same level of [[temperature]] monitoring and control is available for both sides of the bed independently, since– as we know– everyone has unique sleeping [[temperature]] requirements.^[[Sleep Myth Debunked: The 68° Sleeping Temperature (eightsleep.com)](https://www.eightsleep.com/blog/temperature-sleep-myth-debunked)]
3. a new study finds that simply cooling the [[brain]] area just behind the forehead can help.^[[Putting Insomnia on Ice | Scientific American](https://www.scientificamerican.com/article/putting-insomnia-on-ice/)]
...
1. should you sleep with socks on if it's cold + why
	1. Wearing socks can help a process called distal [[vasodilation]], which refers to an increase of [[blood]] to your hands and feet that reduces your core body [[temperature]] quicker.
	   ...
	   2. **see also**: [[microclimate]] > sleep
1. [[cooling vest]] to reduce core body [[temperature]] pre-bedtime
...
## [[circadian rhythm]]
1. how long and when should you warm yourself up throughout the day to improve sleep?
	1. In humans, immersion in hot water prior to, but not immediately before, the sleep period decreases sleep latency and increases sleep depth. This is the known as the ‘Warm Bath Effect’ ([Horne and Reid, 1985](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B59); [Parmeggiani, 1987](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B99); [Bunnell et al., 1988](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B17); [Shapiro et al., 1989](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B117); [Jordan et al., 1990](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B62); [Dorsey et al., 1999](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B32)). In fact, **warming for up to 4 h, between 1 and 8 h before to going to bed, increases slow wave sleep (SWS), increases NREM consolidation and decreases [[REM sleep]]**. This effect embodies a key connection between [[temperature]] and sleep. Warming, at the right [[time]], is causatively associated with sleep initiation. However, sleep initiation occurs within the decline of circadian [[temperature]] and NREM is associated with further reductions in the [[temperature]] of both core and the [[brain]] ([Alföldi et al., 1990](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B4); [Landolt et al., 1995](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B76); [Kräuchi and Wirz-Justice, 2001](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B71)).^[[The Temperature Dependence of Sleep - PMC (nih.gov)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/)]
2. should you increase the length of dark period or light period when wanting to e.g. adjust [[circadian rhythm]] or [[process S|sleep pressure]]?
...
1. the proximal-to-distal [[temperature]] gradient has to increase to improve sleep i.e. higher distal and lower proximal (core body) [[temperature]]
   ...
   The circadian clock prepares the thermoregulatory system for [[vasodilation]] to begin in the early evening as sleepiness increases, followed by a drop in core body [[temperature]]. Even lying down increases sleepiness by redistributing heat in the body from the core to the periphery.
   
   A hotwater bottle at the feet, while not acting on mechanisms in the [[central nervous system]] that underly the regulation of sleep, can rapidly induce [[vasodilation]]. The resulting heat loss is most efficient when the ambient [[temperature]] is cool
   
   Thus, the greater the distal [[vasodilation]] in the late evening, the shorter was the [[time]] taken to fall asleep.^[[Warm feet promote the rapid onset of sleep | Nature](https://www.nature.com/articles/43366)]
   
   **disruption of the peripheral vasodilatory response is sufficient to disrupt sleep**
   The circadian cycle and the onset of the first NREM episode are strongly linked. If sleep onset is postponed by [[sleep deprivation]], then the circadian [[temperature]] rhythm is disrupted. Similarly, a delay in core [[temperature]] decline of more than 2 h, is observed in patients with delayed sleep phase disorders (DSPDs) ([Ozaki et al., 1996](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B96); [van den Heuvel et al., 1998](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B140); [Watanabe et al., 2003](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B147)). Disruption of the peripheral vasodilatory response is sufficient to disrupt sleep. For instance, those with difficulty in peripheral [[vasodilation]] (vasospastic disorders) have longer sleep latencies than healthy controls ([Pache et al., 2001](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B97)). Narcoleptic patients also have a strongly altered proximal-to-distal skin [[temperature]] gradient during daytime waking ([Fronczek et al., 2006](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B38)). But manipulating the proximal-to-distal relationship can change sleep propensity. Warming of the core (proximal-skin) by less than 1°C, easily within the range encountered within the circadian day, is sufficient to shorten sleep latency ([Raymann et al., 2005](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B106)). [[Temperature]] manipulation can also selectively and predictably alter vigilance states in patients with narcolepsy ([Fronczek et al., 2008a](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B39),[b](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B40)). Additional work in the clinic has shown that neonates are three times more likely to fall asleep within 30 min, if their distal-to-proximal skin gradient is greater than 2.5°C ([Abe and Kodama, 2015](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B1)). Distal [[vasodilation]] and higher foot [[temperature]] in preterm neonates is also correlated with shorter wake bouts ([Barcat et al., 2017](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B5)).^[[The Temperature Dependence of Sleep - PMC (nih.gov)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/)]

## [[temperature]]
1. Optimal ambient temperatures, in combination with bedding, appear to be crucial for efficient sleep onset in humans ([Haskell et al., 1981](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B55); [Okamoto-Mizuno et al., 2003](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B95); [Raymann et al., 2008](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B107)). Responses to external [[temperature]] also appear to be important as the extent of [[vasodilation]], particularly in the hands and feet (distal-skin), is a good predictor of sleep initiation ([Krauchi et al., 1999](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B68)). This [[vasodilation]] is usually considered part of the circadian [[temperature]] decline and is observed up to 2 h prior to the start of the first sleep episode, during the wake phase ([Krauchi et al., 2000](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B69)).
   
   In experiments where participants ‘self-selected’ their bed [[time]], subjects were most likely to select a moment when the body [[temperature]] was at its maximum rate of decline ([Campbell and Broughton, 1994](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B18)). As sleep approaches, core [[temperature]] and [[heart rate]] drop, and their steepest decline intersects ‘lights-off’ and sleep onset ([Figure 2B](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/figure/F2/)). At this point the proximal-to-distal [[temperature]] gradient is as much as 1.5°C, but as core [[temperature]] falls the gradient reduces to about 0.5°C; a new cooler set-point is reached just after sleep onset. The lowest core [[temperature]] is observed about 2 h after ‘lights-off’ and sleep onset in _Homo sapiens_ ([Krauchi et al., 2000](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B69)). Under natural conditions, increased circulating melatonin also coincides with declining core [[temperature]] prior to sleep onset ([Krauchi et al., 1997](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B70); [Krauchi et al., 2006](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B67); [Logan and McClung, 2019](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/#B81)).^[[The Temperature Dependence of Sleep - PMC (nih.gov)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6491889/)]
   
   Much like your sleep pattern, your body [[temperature]] also follows a 24-hour cycle as part of the _[[circadian rhythm]]_.  Generally speaking, your body [[temperature]] decreases at night and rises during the day (within 2-3°F normally).
   
   It turns out that there is a lot of variation among individuals in their [[temperature]] needs and preferences.  [Scientists](https://link.springer.com/article/10.1007/BF01952376) have found a range of temperatures under the covers among people when they sleep, up to 5-10°F, which indicates that different people have different “set points” for their sleeping [[temperature]] and [[energy]] requirements.
   
   [A 2005 survey](https://www.tandfonline.com/doi/abs/10.1207/s15402010bsm0304_3) also showed that personal preference for bedroom [[temperature]] was quite varied, as well.  Responses indicated ideal temperatures ranging from below 60°F up to 75°F.  Interestingly, the #2 most important factor the participants indicated for [[sleep quality]], second to location of sleep, was the [[temperature]].
...
1. what should the composition of the meal be if you want to eat before bedtime?
	...
	2. evening [[protein]] intake (gkg-1) was associated with shortened SOL [β=-2, 95%CI: -4 to -0.4), p=0.02]^[[Nutrient intake, meal timing and sleep in elite male Australian football players - PubMed (nih.gov)](https://pubmed.ncbi.nlm.nih.gov/32624442/)]
	3. favorite flavor: salted (caramel) to e.g. retain fluids
2. high vs. low GI evening meal → sleep
	1. The evening intake of high GI carbohydrates was associated with improvements in sleep latency, WASO, and [[sleep efficiency]] in two studies of athletically trained populations. In a double- randomized crossover study of recreationally trained males, consumption of a high GI meal (containing 2 g·kg−1 carbohydrates) immediately post evening sprint exercises increased [[total sleep time]] and [[sleep efficiency]], and decreased WASO and sleep latency compared to a low GI meal as measured by [[polysomnography]]^[[[PDF] The Impact of Dietary Factors on the Sleep of Athletically Trained Populations: A Systematic Review | Semantic Scholar](https://www.semanticscholar.org/reader/950985f4337895eac5a687522ffd60323bdd898c)]
