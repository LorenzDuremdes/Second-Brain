...
var ObsidianGit = /** @class */ (function (_super) {
    ...
    ObsidianGit.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var adapter, path, isValidRepo, now, last, diff, now, last, diff, error_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (!isValidRepo) {
                            ...
                            if (this.settings.autoSaveInterval > 0) {
                                ...
                                diff = this.settings.autoSaveInterval - (Math.round(((now.getTime() - last.getTime()) / 1000) / 60));
                                this.startAutoBackup(diff <= 0 ? 0 : diff);
                            }
                            if (this.settings.autoPullInterval > 0) {
                                now = new Date();
                                last = new Date(this.settings.lastAutoPull);
                                diff = this.settings.autoPullInterval - (Math.round(((now.getTime() - last.getTime()) / 1000) / 60));
