1. relaxation (approximation); an approximation of a difficult problem by a nearby problem that is easier to solve^[https://en.wikipedia.org/wiki/Relaxation_(approximation)]
