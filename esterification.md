1. esterification; the general name for a chemical reaction in which two reactants (typically an alcohol and an acid) form an ester as the reaction product^[https://en.wikipedia.org/wiki/Ester#Preparation]
