1. vector space model; an algebraic model for representing text documents (and any objects, in general) as vectors of identifiers (such as index terms)^[https://en.wikipedia.org/wiki/Vector_space_model]
